...
public class AnimationUtils {
    ...
    public static void PlayerAnim(Player player,int SkillID, String type){
        ...
        if (animationLayer != null && PlayerAnimationRegistry.getAnimation(animationId) != null) {
            animationLayer.setAnimation(new KeyframeAnimationPlayer((dev.kosmx.playerAnim.core.data.KeyframeAnimation) Objects.requireNonNull(PlayerAnimationRegistry.getAnimation(animationId))));
        }
