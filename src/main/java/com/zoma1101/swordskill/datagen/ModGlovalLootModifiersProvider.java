...
public class ModGlovalLootModifiersProvider extends GlobalLootModifierProvider {
    public ModGlovalLootModifiersProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
        super(output, registries, SwordSkill.MOD_ID);
    }

    @Override
    protected void start() {
        UnlockItem_Chests("village_mason", 0.1f);
        UnlockItem_Chests("village_weaponsmith", 0.5f);

        UnlockItem_Chests("simple_dungeon", 0.3f);
        UnlockItem_Chests("desert_pyramid", 0.7f);
        UnlockItem_Chests("igloo_chest", 0.3f);
        UnlockItem_Chests("shipwreck_treasure", 0.5f);
        UnlockItem_Chests("village_armorer", 0.3f);
        UnlockItem_Chests("shipwreck_treasure", 0.3f);
        UnlockItem_Chests("shipwreck_treasure", 0.3f);
        UnlockItem_Chests("simple_dungeon", 0.6f);
        UnlockItem_Chests("simple_dungeon", 0.4f);

        UnlockItem_Chests("ancient_city", 0.7f);
        UnlockItem_Chests("ancient_city_ice_box", 0.9f);
        UnlockItem_Chests("bastion_treasure", 0.8f);
        UnlockItem_Chests("buried_treasure", 0.9f);
