...
import static com.zoma1101.swordskill.data.WeaponTypeUtils.NONE_WEAPON_DATA;
...
public class AutoWeaponDataSetter {
    ...
    public static WeaponData AutoWeaponDataSetting(ItemStack heldItem) {
        ...
        } else if (itemName.contains("axe") && !itemName.contains("pickaxe")  && !itemName.contains("waxed") || heldItem.getItem() instanceof AxeItem) {
