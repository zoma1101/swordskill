...
public class SwordSkill_Entities {
        public static final DeferredRegister<EntityType<?>> ENTITY_TYPES = DeferredRegister
                        .create(ForgeRegistries.ENTITY_TYPES, SwordSkill.MOD_ID);

        public static final RegistryObject<EntityType<AttackEffectEntity>> ATTACK_EFFECT = ENTITY_TYPES
                        .register("attack_effect",
