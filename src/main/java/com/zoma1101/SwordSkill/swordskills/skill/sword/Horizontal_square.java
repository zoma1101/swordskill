...
public class Horizontal_square extends BaseSkill {
    ...
    public void execute(Level level, ServerPlayer player, int tickCount, int SkillID) {
        if (tickCount == 5) {
            spawnRelativeSlash(level, player, -2.0, 0.0, 0.0, new Vec3(6, 180, -5), new Vector3f(7.2f, 3f, 2.4f), 1.25f,
                    0.75);
            swingArm(player);
        }
            ...
            spawnMovingRelativeSlash(level, player, 1.0, -1.0, 0.0, new Vec3(0, -45, 0), new Vector3f(2.4f, 3f, 2.4f), 1.5f, 0.75,SkillID, new Vec3(0,0,10));
            spawnMovingRelativeSlash(level, player, -1.0, 1.0, 0.0, new Vec3(0, 135, 0), new Vector3f(2.4f, 3f, 2.4f), 1.5f, 0.75,SkillID, new Vec3(0,0,10));
            spawnMovingRelativeSlash(level, player, -1.0, -1.0, 0.0, new Vec3(0,-135 , 0), new Vector3f(2.4f, 3f, 2.4f), 1.5f, 0.75,SkillID, new Vec3(0,0,10));
            swingArm(player);
        }
    }
