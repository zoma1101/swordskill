...
public class SampleItemRegistry {
    ...
    public static final RegistryObject<Item> SAMPLE_GREAT_SWORD = ITEMS.register("sample_great_sword", () -> new SampleWeapon(Tiers.IRON, 5, -2.9F, new Item.Properties()));
    ...
    public static final RegistryObject<Item> SAMPLE_SWORD = ITEMS.register("sample_sword", () -> new SampleWeapon(Tiers.IRON, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> SAMPLE_ITEM = ITEMS.register("sample_item", () -> new Item(new Item.Properties()));
